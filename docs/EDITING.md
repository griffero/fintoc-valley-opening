...
- `lib/ai-era.ts`: Twitter/SpaceX sign replacement and rocket launch, OpenAI/Anthropic rooftop identities, and three animated OpenClaw lobsters. See `docs/AI-ERA-DETAILS.md` for timing and factual references.
