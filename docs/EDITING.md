...
- `lib/tech-era.ts`: eight Waymo robotaxis, an unfinished fusion reactor, NFT/Web3 domino collapse and the large NVIDIA compute campus. Positions, routes and timing are documented in `docs/TECH-ERA-DETAILS.md`.
