...
- **OpenClaw:** una langosta de mayor tamaño aparece desde 7,3 segundos en la esquina libre junto a la piscina de OpenAI, con cola segmentada, patas, antenas y pinzas animadas. Su escala 2,05 y orientación paralela a la fachada la hacen legible en el encuadre final; la placa queda al otro extremo de la terraza. Es un modelo propio en geometría, inspirado en la identidad de [OpenClaw](https://openclaw.ai/) y su [símbolo oficial](https://openclaw.ai/favicon.svg).
